...
client = MongoClient("mongodb+srv://abinayasint:abinayaa@clustername.nhuvshg.mongodb.net/")
collection = client["todolist_db"]["tasks"]  # "todolist_db" is DB name, "tasks" is collection
